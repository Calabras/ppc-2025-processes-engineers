...
Результаты тестов производительности на строке из 100,000,000 предложений (~2,500,000,000 символов):

| Mode        | Processes | Time (s)  | Speedup | Efficiency |
|-------------|-----------|-----------|---------|------------|
| SEQ         | 1         | 1.540     | 1.00    | N/A        |
| MPI pipeline| 4         | 0.520     | 2.96    | 74.0%      |
| MPI task_run| 4         | 0.395     | 3.90    | 97.5%      |
