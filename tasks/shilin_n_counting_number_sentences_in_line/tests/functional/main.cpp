...
const std::array<TestType, 24> kTestParam = {
    ...
    std::make_tuple("A.B.C", "3"),                  // Минимальные предложения
    std::make_tuple("abc..def.", "1"),              // Последовательные точки на границе чанка
    std::make_tuple("abc...def.", "1"),             // Многоточие на границе чанка
