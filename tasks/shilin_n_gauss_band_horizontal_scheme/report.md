...
Реализация протестирована на матрицах размера 100×100. Ниже приведены измеренные значения времени выполнения (в секундах) для режимов `pipeline` и `task_run`.

| Число процессов | MPI pipeline, s | MPI task_run, s | SEQ pipeline, s | SEQ task_run, s |
|----------------|----------------:|----------------:|----------------:|----------------:|
| 1              | 0.0001806000     | 0.0002376000     | 0.0000149250     | 0.0000135584     |
| 2              | 0.0001618000     | 0.0001628000     | 0.0000149250     | 0.0000135584     |
| 4              | 0.0006638000     | 0.0002836000     | 0.0000149250     | 0.0000135584     |
